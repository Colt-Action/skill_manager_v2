...
export default async function ProfilSeite() {
  ...
  return (
    <div className="mx-auto max-w-xl px-4 py-8">
      <p className="font-mono text-xs uppercase tracking-widest text-signal">{t("profil.eyebrow", sprache)}</p>
      <h1 className="mt-1 font-display text-3xl font-bold text-ink">{t("profil.titel", sprache)}</h1>
      <p className="mt-1 text-sm text-ink-soft">{t("profil.untertitel", sprache)}</p>
