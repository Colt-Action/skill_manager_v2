...
// den früheren Phasen. Läuft auf dem hellen Nav-Hintergrund, daher ist
// das Dreieck bewusst in --surface eingefärbt ("ausgestanzt").
export default function Logo({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 40 40" className={className} aria-hidden="true">
      ...
      <path d="M16.5 13.5 L27 20 L16.5 26.5 Z" fill="var(--surface)" />
    </svg>
  );
}
