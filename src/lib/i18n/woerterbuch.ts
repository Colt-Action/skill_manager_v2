...
export const WOERTERBUCH: Record<string, Record<Sprache, string>> = {
  ...
  "passwortVergessen.codeHinweis": {
    de: "Code aus der E-Mail, die gerade verschickt wurde.",
    en: "Code from the email that was just sent.",
    es: "Código del correo que se acaba de enviar.",
    pt: "Código do e-mail que acabou de ser enviado.",
    sv: "Kod från e-posten som just skickades.",
    fi: "Koodi juuri lähetetystä sähköpostista.",
    zh: "刚发送的邮件中的验证码。",
    ja: "先ほど送信されたメール内のコードです。",
    id: "Kode dari email yang baru saja dikirim.",
    ms: "Kod daripada e-mel yang baru sahaja dihantar.",
    af: "Kode uit die e-pos wat nou net gestuur is.",
  },
