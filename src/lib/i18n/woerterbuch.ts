...
export const WOERTERBUCH: Record<string, Record<Sprache, string>> = {
  ...
  "dashboard.merklisteLeer": {
    de: "Noch nichts gemerkt. Klick auf den Stern ★ bei Videos oder Referenzen, um sie hier zu sammeln.",
    en: "Nothing saved yet. Click the ★ star on videos or references to collect them here.",
    es: "Aún no hay nada guardado. Haz clic en la estrella ★ de videos o referencias para reunirlos aquí.",
    pt: "Nada salvo ainda. Clique na estrela ★ em vídeos ou referências para reuni-los aqui.",
    sv: "Inget sparat ännu. Klicka på stjärnan ★ på videor eller referenser för att samla dem här.",
    fi: "Ei vielä mitään tallennettuna. Napsauta ★-tähteä videoissa tai viitteissä kerätäksesi ne tänne.",
    zh: "还没有收藏任何内容。点击视频或参考资料上的 ★ 星标即可收藏到这里。",
    ja: "まだ何も保存されていません。動画や参考資料の★スターをクリックしてここに集めましょう。",
    id: "Belum ada yang disimpan. Klik bintang ★ pada video atau referensi untuk mengumpulkannya di sini.",
    ms: "Belum ada yang disimpan. Klik bintang ★ pada video atau rujukan untuk mengumpulkannya di sini.",
    af: "Nog niks gestoor nie. Klik die ★-ster by video's of verwysings om dit hier te versamel.",
  },
  "dashboard.neuImReferenzbereich": {
    de: "Neu im Referenzbereich", en: "New in the reference area", es: "Nuevo en referencias", pt: "Novo na área de referências", sv: "Nytt i referensområdet",
    fi: "Uutta viitealueella", zh: "参考区新增", ja: "リファレンスエリアの新着", id: "Baru di area referensi", ms: "Baharu dalam kawasan rujukan", af: "Nuut in die verwysingsarea",
  },
  "dashboard.keineReferenzenVeroeffentlicht": {
    de: "Noch keine veröffentlichten Referenzen.", en: "No published references yet.", es: "Aún no hay referencias publicadas.", pt: "Ainda não há referências publicadas.", sv: "Inga publicerade referenser ännu.",
    fi: "Ei vielä julkaistuja viitteitä.", zh: "尚无已发布的参考资料。", ja: "公開された参考資料はまだありません。", id: "Belum ada referensi yang dipublikasikan.", ms: "Belum ada rujukan diterbitkan.", af: "Nog geen gepubliseerde verwysings nie.",
  },
  "dashboard.merkteamAktivitaet": {
    de: "Merkteam-Aktivität", en: "Team activity", es: "Actividad del equipo", pt: "Atividade da equipe", sv: "Teamaktivitet",
    fi: "Tiimin toiminta", zh: "团队动态", ja: "チームのアクティビティ", id: "Aktivitas tim", ms: "Aktiviti pasukan", af: "Spanaktiwiteit",
  },
  "dashboard.merkteamAktivitaetEintrag": {
    de: "{name} hat „{titel}“ in {team} gemerkt",
    en: "{name} saved “{titel}” in {team}",
    es: "{name} guardó «{titel}» en {team}",
    pt: "{name} salvou “{titel}” em {team}",
    sv: "{name} sparade ”{titel}” i {team}",
    fi: "{name} tallensi kohteen ”{titel}” tiimiin {team}",
    zh: "{name} 在 {team} 中收藏了「{titel}」",
    ja: "{name}さんが{team}で「{titel}」を保存しました",
    id: "{name} menyimpan “{titel}” di {team}",
    ms: "{name} menyimpan “{titel}” dalam {team}",
    af: "{name} het “{titel}” in {team} gestoor",
  },
  "dashboard.deineUploads": {
    de: "Deine Uploads", en: "Your uploads", es: "Tus subidas", pt: "Seus envios", sv: "Dina uppladdningar",
    fi: "Lataamasi", zh: "你的上传", ja: "あなたのアップロード", id: "Unggahan Anda", ms: "Muat naik anda", af: "Jou oplaaie",
  },
  "dashboard.uploadsInPruefung": {
    de: "in Prüfung", en: "in review", es: "en revisión", pt: "em revisão", sv: "under granskning",
    fi: "tarkistuksessa", zh: "审核中", ja: "審査中", id: "dalam peninjauan", ms: "dalam semakan", af: "onder hersiening",
  },
  "dashboard.uploadsVeroeffentlicht": {
    de: "veröffentlicht", en: "published", es: "publicado", pt: "publicado", sv: "publicerat",
    fi: "julkaistu", zh: "已发布", ja: "公開済み", id: "dipublikasikan", ms: "diterbitkan", af: "gepubliseer",
  },
  ...
  "admin.referenzenLeer": {
    de: "Aktuell gibt es keine Referenzen zu bearbeiten.",
    en: "There are currently no references to work on.",
    es: "Actualmente no hay referencias para editar.",
    pt: "Atualmente não há referências para editar.",
    sv: "Det finns för närvarande inga referenser att bearbeta.",
    fi: "Ei tällä hetkellä muokattavia referenssejä.",
    zh: "目前没有需要处理的参考资料。",
    ja: "現在編集できるリファレンスはありません。",
    id: "Saat ini tidak ada referensi untuk dikerjakan.",
    ms: "Buat masa ini tiada rujukan untuk diusahakan.",
    af: "Daar is tans geen verwysings om aan te werk nie.",
  },
  "admin.pruefungLeer": {
  ...
  "merkStern.fehler": {
    ...
    es: "No se pudo guardar. Inténtalo de nuevo más tarde.",
    pt: "Não foi possível salvar. Tente novamente mais tarde.",
    sv: "Kunde inte sparas. Försök igen senare.",
    fi: "Tallennus epäonnistui. Yritä myöhemmin uudelleen.",
    zh: "无法收藏，请稍后重试。",
    ja: "保存できませんでした。後でもう一度お試しください。",
    id: "Tidak dapat disimpan. Silakan coba lagi nanti.",
    ms: "Tidak dapat disimpan. Sila cuba lagi kemudian.",
    af: "Kon nie stoor nie. Probeer asseblief later weer.",
  },
  ...
  "passwortVergessen.untertitel": {
    de: "Gib deine E-Mail-Adresse ein, wir schicken dir einen Code zum Zurücksetzen.",
    en: "Enter your email address, we'll send you a code to reset it.",
    es: "Introduce tu dirección de correo, te enviaremos un código para restablecerla.",
    pt: "Digite seu e-mail, enviaremos um código para redefinir.",
    sv: "Ange din e-postadress, vi skickar en kod för återställning.",
    fi: "Anna sähköpostiosoitteesi, lähetämme sinulle nollauskoodin.",
    zh: "输入你的电子邮箱，我们会发送重置验证码给你。",
    ja: "メールアドレスを入力してください。リセット用のコードをお送りします。",
    id: "Masukkan alamat email Anda, kami akan mengirimkan kode untuk mengatur ulang.",
    ms: "Masukkan alamat e-mel anda, kami akan hantar kod untuk menetapkan semula.",
    af: "Voer jou e-posadres in, ons stuur vir jou 'n kode om dit terug te stel.",
  },
  "passwortVergessen.sendenButton": {
    de: "Code senden", en: "Send code", es: "Enviar código", pt: "Enviar código", sv: "Skicka kod",
    fi: "Lähetä koodi", zh: "发送验证码", ja: "コードを送信", id: "Kirim kode", ms: "Hantar kod", af: "Stuur kode",
  },
  "passwortVergessen.codeLabel": {
    de: "Code aus der E-Mail", en: "Code from the email", es: "Código del correo", pt: "Código do e-mail", sv: "Kod från e-posten",
    fi: "Koodi sähköpostista", zh: "邮件中的验证码", ja: "メール内のコード", id: "Kode dari email", ms: "Kod daripada e-mel", af: "Kode uit die e-pos",
  },
  "passwortVergessen.codeHinweis": {
    de: "6-stelliger Code, wurde gerade per E-Mail verschickt.",
    en: "6-digit code, just sent by email.",
    es: "Código de 6 dígitos, recién enviado por correo.",
    pt: "Código de 6 dígitos, acabou de ser enviado por e-mail.",
    sv: "6-siffrig kod, skickades just via e-post.",
    fi: "6-numeroinen koodi, lähetetty juuri sähköpostitse.",
    zh: "6 位验证码，已通过邮件发送。",
    ja: "6桁のコードをメールで送信しました。",
    id: "Kode 6 digit, baru saja dikirim melalui email.",
    ms: "Kod 6 digit, baru sahaja dihantar melalui e-mel.",
    af: "6-syfer kode, is nou net per e-pos gestuur.",
  },
  "passwortVergessen.codeUngueltig": {
    de: "Code ungültig oder abgelaufen. Bitte einen neuen Code anfordern.",
    en: "Code invalid or expired. Please request a new code.",
    es: "Código inválido o caducado. Solicita un nuevo código.",
    pt: "Código inválido ou expirado. Solicite um novo código.",
    sv: "Koden är ogiltig eller har gått ut. Begär en ny kod.",
    fi: "Koodi on virheellinen tai vanhentunut. Pyydä uusi koodi.",
    zh: "验证码无效或已过期。请重新申请验证码。",
    ja: "コードが無効か期限切れです。新しいコードをリクエストしてください。",
    id: "Kode tidak valid atau kedaluwarsa. Silakan minta kode baru.",
    ms: "Kod tidak sah atau tamat tempoh. Sila minta kod baharu.",
    af: "Kode ongeldig of verval. Versoek asseblief 'n nuwe kode.",
  },
  "passwortVergessen.neuenCodeAnfordern": {
  ...
  "passwortZuruecksetzen.speichertLaeuft": {
    de: "Speichert …", en: "Saving …", es: "Guardando …", pt: "Salvando …", sv: "Sparar …",
    fi: "Tallennetaan …", zh: "保存中…", ja: "保存中…", id: "Menyimpan …", ms: "Menyimpan …", af: "Stoor tans …",
  },
  ...
  "lernpfade.eyebrow": {
    de: "Wissen strukturiert", en: "Structured knowledge", es: "Conocimiento estructurado", pt: "Conhecimento estruturado", sv: "Strukturerad kunskap",
    fi: "Jäsennelty tieto", zh: "结构化知识", ja: "体系化された知識", id: "Pengetahuan terstruktur", ms: "Pengetahuan berstruktur", af: "Gestruktureerde kennis",
  },
  "lernpfade.titel": {
    de: "Lernpfade", en: "Learning Paths", es: "Rutas de aprendizaje", pt: "Trilhas de aprendizagem", sv: "Lärvägar",
    fi: "Oppimispolut", zh: "学习路径", ja: "学習パス", id: "Jalur Pembelajaran", ms: "Laluan Pembelajaran", af: "Leerpaaie",
  },
  "lernpfade.untertitel": {
    de: "Videos in sinnvoller Reihenfolge, z. B. für den Einstieg in ein Thema.",
    en: "Videos in a sensible order, e.g. for getting started with a topic.",
    es: "Videos en un orden lógico, p. ej. para introducirse en un tema.",
    pt: "Vídeos numa ordem lógica, por exemplo, para iniciar num tema.",
    sv: "Videor i en meningsfull ordning, t.ex. för att komma igång med ett ämne.",
    fi: "Videot järkevässä järjestyksessä, esim. aiheeseen tutustumiseen.",
    zh: "按合理顺序排列的视频，例如用于入门某个主题。",
    ja: "テーマの入門などに役立つ、理にかなった順序の動画です。",
    id: "Video dalam urutan yang masuk akal, misalnya untuk memulai suatu topik.",
    ms: "Video dalam susunan yang munasabah, contohnya untuk bermula dengan topik.",
    af: "Video's in 'n sinvolle volgorde, bv. om met 'n onderwerp te begin.",
  },
  "lernpfade.leer": {
    de: "Aktuell gibt es noch keine Lernpfade.", en: "There are no learning paths yet.", es: "Aún no hay rutas de aprendizaje.", pt: "Ainda não há trilhas de aprendizagem.", sv: "Det finns inga lärvägar än.",
    fi: "Ei vielä oppimispolkuja.", zh: "目前还没有学习路径。", ja: "まだ学習パスがありません。", id: "Belum ada jalur pembelajaran.", ms: "Belum ada laluan pembelajaran.", af: "Nog geen leerpaaie nie.",
  },
  "lernpfade.videosAnzahl": {
    de: "{angesehen}/{gesamt} Videos", en: "{angesehen}/{gesamt} videos", es: "{angesehen}/{gesamt} videos", pt: "{angesehen}/{gesamt} vídeos", sv: "{angesehen}/{gesamt} videor",
    fi: "{angesehen}/{gesamt} videota", zh: "{angesehen}/{gesamt} 个视频", ja: "{angesehen}/{gesamt} 本の動画", id: "{angesehen}/{gesamt} video", ms: "{angesehen}/{gesamt} video", af: "{angesehen}/{gesamt} video's",
  },
  "lernpfade.alleLernpfade": {
    de: "Alle Lernpfade", en: "All learning paths", es: "Todas las rutas de aprendizaje", pt: "Todas as trilhas de aprendizagem", sv: "Alla lärvägar",
    fi: "Kaikki oppimispolut", zh: "所有学习路径", ja: "すべての学習パス", id: "Semua jalur pembelajaran", ms: "Semua laluan pembelajaran", af: "Alle leerpaaie",
  },
  "lernpfade.lernpfad": {
    de: "Lernpfad", en: "Learning Path", es: "Ruta de aprendizaje", pt: "Trilha de aprendizagem", sv: "Lärväg",
    fi: "Oppimispolku", zh: "学习路径", ja: "学習パス", id: "Jalur Pembelajaran", ms: "Laluan Pembelajaran", af: "Leerpad",
  },
  "lernpfade.keineVideosZugeordnet": {
    de: "Diesem Lernpfad wurden noch keine Videos zugeordnet.", en: "No videos have been assigned to this learning path yet.", es: "Aún no se han asignado videos a esta ruta de aprendizaje.", pt: "Ainda não foram atribuídos vídeos a esta trilha.", sv: "Inga videor har tilldelats denna lärväg än.",
    fi: "Tälle oppimispolulle ei ole vielä lisätty videoita.", zh: "此学习路径尚未分配任何视频。", ja: "この学習パスにはまだ動画が割り当てられていません。", id: "Belum ada video yang ditetapkan ke jalur pembelajaran ini.", ms: "Belum ada video ditetapkan kepada laluan pembelajaran ini.", af: "Nog geen video's aan hierdie leerpad toegewys nie.",
  },
  "lernpfade.angesehenAnzahl": {
  ...
  "geraet.keinGeraet": {
    de: "Kein Gerät angegeben", en: "No device specified", es: "No se especificó ningún equipo", pt: "Nenhum equipamento especificado", sv: "Ingen enhet angiven",
    fi: "Laitetta ei määritetty", zh: "未指定设备", ja: "デバイスが指定されていません", id: "Tidak ada perangkat yang ditentukan", ms: "Tiada peranti dinyatakan", af: "Geen toestel gespesifiseer nie",
  },
  "geraet.keinGeraetHinweis": {
    de: "Diese Seite zeigt Videos zu allen Teilen eines Geräts, wenn sie über einen Link mit Teilenummern aufgerufen wird, z. B.",
    en: "This page shows videos for all parts of a device when opened via a link with part numbers, e.g.",
    es: "Esta página muestra videos de todas las piezas de un equipo cuando se abre mediante un enlace con números de pieza, p. ej.",
    pt: "Esta página mostra vídeos de todas as peças de um equipamento quando aberta através de um link com números de peça, por exemplo",
    sv: "Den här sidan visar videor för alla delar av en enhet när den öppnas via en länk med artikelnummer, t.ex.",
    fi: "Tämä sivu näyttää videot laitteen kaikista osista, kun se avataan osanumeroita sisältävän linkin kautta, esim.",
    zh: "当通过带有零件编号的链接打开此页面时，会显示设备所有零件的视频，例如",
    ja: "このページは、部品番号付きのリンクから開くと、機器のすべての部品の動画を表示します。例：",
    id: "Halaman ini menampilkan video untuk semua suku cadang perangkat saat dibuka melalui tautan dengan nomor suku cadang, mis.",
    ms: "Halaman ini memaparkan video untuk semua bahagian peranti apabila dibuka melalui pautan dengan nombor bahagian, cth.",
    af: "Hierdie bladsy wys video's vir alle onderdele van 'n toestel wanneer dit via 'n skakel met onderdeelnommers oopgemaak word, bv.",
  },
  "geraet.keinGeraetLink": {
    de: "Nutz stattdessen die", en: "Use the", es: "Usa en su lugar la", pt: "Use em vez disso a", sv: "Använd istället",
    fi: "Käytä sen sijaan", zh: "请改用", ja: "代わりに", id: "Gunakan sebagai gantinya", ms: "Guna sebaliknya", af: "Gebruik eerder die",
  },
  "geraet.videoBibliothek": {
    de: "Video-Bibliothek", en: "video library", es: "biblioteca de videos", pt: "biblioteca de vídeos", sv: "videobiblioteket",
    fi: "videokirjastoa", zh: "视频库", ja: "動画ライブラリ", id: "perpustakaan video", ms: "perpustakaan video", af: "videobiblioteek",
  },
  "geraet.umGezieltZuSuchen": {
    de: ", um gezielt zu suchen.", en: " to search specifically.", es: " para buscar de forma específica.", pt: " para pesquisar especificamente.", sv: " för att söka specifikt.",
    fi: " kohdennettuun hakuun.", zh: "，以便精确搜索。", ja: "で絞り込んで検索してください。", id: " untuk mencari secara spesifik.", ms: " untuk mencari secara khusus.", af: " om spesifiek te soek.",
  },
  "geraet.titelFallback": {
    de: "Verbaute Teile & Videos", en: "Installed parts & videos", es: "Piezas instaladas y videos", pt: "Peças instaladas e vídeos", sv: "Monterade delar & videor",
    fi: "Asennetut osat ja videot", zh: "已安装的零件和视频", ja: "搭載部品と動画", id: "Suku cadang & video terpasang", ms: "Bahagian & video dipasang", af: "Geïnstalleerde onderdele & video's",
  },
  "geraet.untertitel": {
    de: "Alle Videos zu den {anzahl} Teilen, die laut Geräte-Konfiguration verbaut sind.",
    en: "All videos for the {anzahl} parts installed according to the device configuration.",
    es: "Todos los videos de las {anzahl} piezas instaladas según la configuración del equipo.",
    pt: "Todos os vídeos das {anzahl} peças instaladas conforme a configuração do equipamento.",
    sv: "Alla videor för de {anzahl} delarna som är monterade enligt enhetskonfigurationen.",
    fi: "Kaikki videot {anzahl} osasta, jotka on asennettu laitteen kokoonpanon mukaan.",
    zh: "根据设备配置安装的 {anzahl} 个零件的所有视频。",
    ja: "デバイス構成に基づいて搭載されている {anzahl} 個の部品のすべての動画。",
    id: "Semua video untuk {anzahl} suku cadang yang terpasang sesuai konfigurasi perangkat.",
    ms: "Semua video untuk {anzahl} bahagian yang dipasang mengikut konfigurasi peranti.",
    af: "Alle video's vir die {anzahl} onderdele wat volgens die toestelkonfigurasie geïnstalleer is.",
  },
  "geraet.angeforderteTeilenummern": {
    de: "Angeforderte Teilenummern: {nummern}", en: "Requested part numbers: {nummern}", es: "Números de pieza solicitados: {nummern}", pt: "Números de peça solicitados: {nummern}", sv: "Begärda artikelnummer: {nummern}",
    fi: "Pyydetyt osanumerot: {nummern}", zh: "请求的零件编号：{nummern}", ja: "要求された部品番号：{nummern}", id: "Nomor suku cadang yang diminta: {nummern}", ms: "Nombor bahagian diminta: {nummern}", af: "Aangevraagde onderdeelnommers: {nummern}",
  },
  "geraet.nichtGefunden": {
    de: "Nicht in Skill Manager gefunden: {nummern} – für diese Teile fehlt evtl. noch ein Eintrag unter „Kategorien & Teile“.",
    en: "Not found in Skill Manager: {nummern} – these parts may still be missing an entry under \"Categories & Parts\".",
    es: "No encontrado en Skill Manager: {nummern} – a estas piezas quizás les falte aún una entrada en \"Categorías y piezas\".",
    pt: "Não encontrado no Skill Manager: {nummern} – a estas peças pode faltar ainda uma entrada em \"Categorias e peças\".",
    sv: "Hittades inte i Skill Manager: {nummern} – dessa delar saknar kanske fortfarande en post under \"Kategorier & delar\".",
    fi: "Ei löytynyt Skill Managerista: {nummern} – näiltä osilta saattaa vielä puuttua merkintä kohdassa \"Kategoriat ja osat\".",
    zh: "在 Skill Manager 中未找到：{nummern} — 这些零件可能仍缺少\"分类与零件\"下的条目。",
    ja: "Skill Manager内に見つかりません：{nummern} — これらの部品には「カテゴリと部品」にまだ登録がない可能性があります。",
    id: "Tidak ditemukan di Skill Manager: {nummern} – suku cadang ini mungkin masih memerlukan entri di \"Kategori & Suku Cadang\".",
    ms: "Tidak dijumpai dalam Skill Manager: {nummern} – bahagian ini mungkin masih memerlukan entri di \"Kategori & Bahagian\".",
    af: "Nie in Skill Manager gevind nie: {nummern} – hierdie onderdele kort dalk nog 'n inskrywing onder \"Kategorieë & Onderdele\".",
  },
  "geraet.keineVideos": {
    de: "Für die gefundenen Teile gibt es aktuell noch kein veröffentlichtes Video.", en: "There is currently no published video for the parts found.", es: "Actualmente no hay ningún video publicado para las piezas encontradas.", pt: "Atualmente não há nenhum vídeo publicado para as peças encontradas.", sv: "Det finns för närvarande ingen publicerad video för de hittade delarna.",
    fi: "Löydetyille osille ei ole vielä julkaistua videota.", zh: "目前尚无针对所找到零件发布的视频。", ja: "見つかった部品に対する公開済みの動画は現在ありません。", id: "Saat ini belum ada video yang dipublikasikan untuk suku cadang yang ditemukan.", ms: "Buat masa ini tiada video diterbitkan untuk bahagian yang dijumpai.", af: "Daar is tans geen gepubliseerde video vir die gevonde onderdele nie.",
  },
  "teilScan.eyebrow": {
    de: "Teil-Scan", en: "Part scan", es: "Escaneo de pieza", pt: "Digitalização de peça", sv: "Delskanning",
    fi: "Osaskannaus", zh: "零件扫描", ja: "部品スキャン", id: "Pemindaian suku cadang", ms: "Imbasan bahagian", af: "Onderdeel-skandering",
  },
  "teilScan.keineVideos": {
    de: "Für dieses Teil gibt es aktuell noch kein veröffentlichtes Video.", en: "There is currently no published video for this part.", es: "Actualmente no hay ningún video publicado para esta pieza.", pt: "Atualmente não há nenhum vídeo publicado para esta peça.", sv: "Det finns för närvarande ingen publicerad video för denna del.",
    fi: "Tälle osalle ei ole vielä julkaistua videota.", zh: "目前尚无针对此零件发布的视频。", ja: "この部品に対する公開済みの動画は現在ありません。", id: "Saat ini belum ada video yang dipublikasikan untuk suku cadang ini.", ms: "Buat masa ini tiada video diterbitkan untuk bahagian ini.", af: "Daar is tans geen gepubliseerde video vir hierdie onderdeel nie.",
  },
  "geraet.angemeldetAls": {
    de: "Angemeldet als {name}. Diese Seite ist für Links aus der Service-App gedacht, die an einem TAG (QR-Code/NFC) hinterlegt werden.",
    en: "Logged in as {name}. This page is intended for links from the service app stored on a TAG (QR code/NFC).",
    es: "Sesión iniciada como {name}. Esta página está pensada para enlaces de la app de servicio guardados en un TAG (QR/NFC).",
    pt: "Sessão iniciada como {name}. Esta página destina-se a links da app de assistência guardados numa TAG (QR/NFC).",
    sv: "Inloggad som {name}. Den här sidan är avsedd för länkar från serviceappen som lagras på en TAG (QR-kod/NFC).",
    fi: "Kirjautunut käyttäjänä {name}. Tämä sivu on tarkoitettu palveluappista tuleville linkeille, jotka on tallennettu TAG-tunnisteeseen (QR-koodi/NFC).",
    zh: "以 {name} 身份登录。此页面用于存储在 TAG（二维码/NFC）上的服务应用链接。",
    ja: "{name} としてログイン中。このページはTAG（QRコード/NFC）に保存されたサービスアプリからのリンク用です。",
